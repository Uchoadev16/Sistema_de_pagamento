...
<body class="bg-gray-900 font-sans text-gray-200 min-h-screen flex items-center justify-center">
    <div class="container mx-auto px-4 py-8 max-w-md">
        ...
        <form action="../../controllers/controller_autenticacao.php" method="post" class="bg-gray-800 rounded-lg shadow-lg p-6 sm:p-8">
            ...
            <button type="submit" class="w-full bg-yellow-500 text-gray-900 px-4 py-3 rounded-lg hover:bg-yellow-400 transition duration-300 text-sm sm:text-base font-semibold">Entrar</button>
            <p class="text-gray-400 text-center mt-4 text-sm">Não é cadastrado? <a href="./cadastro.php" class="text-yellow-400 hover:text-yellow-300 transition duration-300">Cadastre-se</a></p>
        </form>
    </div>
</body>
</html>