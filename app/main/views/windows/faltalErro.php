...
<body class="bg-gray-900 font-sans text-gray-200 min-h-screen flex flex-col">
    ...
    <main class="container mx-auto px-4 py-8 flex-grow flex items-center justify-center">
        <section class="text-center max-w-md">
            ...
            <h1 class="text-3xl sm:text-4xl font-bold text-yellow-400 mb-4">Erro falta ao carregar página</h1>
            ...
            <?php else: ?>
                <p class="text-base sm:text-lg text-gray-400 mb-6">Não foi possível conectar a página. Tente novamente mais tarde.</p>
            <?php endif; ?>
